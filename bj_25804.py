...
# (문제)
# R, A, B의 세 정수가 주어진다.
# 당신은 무한대 심볼의 중앙(S)에 위치해 있으며, 중앙(S)에서 먼저 오른쪽으로 반지름이 R인 원을 그린다.
# 그리고 중앙(S)에서 왼쪽으로 반지름이 (R x A)인 원을 그린다.
...
# 반지름이 0이 될때까지, 생산된 원의 전체 넓이(the sum of areas of all the circles)를 구하시오.
#########################
