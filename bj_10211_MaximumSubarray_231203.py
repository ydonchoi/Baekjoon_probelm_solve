#파이썬 #백준 #문제풀이 #10211번 #MaximumSubarray #최영돈(231203,band.us/@ydonchoi)
'''
(문제)
크기 N인 정수형 배열 X가 있을 때,
X의 부분 배열(X의 연속한 일부분) 중 각 원소의 합이 가장 큰 부분 배열을 찾는 Maximum subarray problem(최대 부분배열 문제)은 컴퓨터 과학에서 매우 잘 알려져 있다.
