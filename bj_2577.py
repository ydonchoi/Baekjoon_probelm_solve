...
def num_counter(number: int) -> dict:
	''' the counter is that keys aer composed to numbers from 0 to 9 and values are composed to all 0, in order to counting from number 0 to number 9
...
def generate_number() -> str:
	''' generate each number A, B, and C, and multiply given three numbers A, B, and C, and returns computing result '''
